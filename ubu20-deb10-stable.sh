...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > zoolztheaz${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "  This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}zoolztheaz® ${NC}${YELLOW}(${NC} ${green} zoolztheaz  ${NC}${YELLOW})${NC}"
echo -e "  Recode By My Self zoolztheaz ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/zoolztheaz1990/Apex/ZX/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/zoolztheaz1990/Apex/ZX/REGISTRASI"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="6191040634"
KEY="6597719735:AAFgWGKqnDF1fk2mM4lj5jGvt4v5EY3D55s"
...
<code>â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</code>
<b> ðŸ‡®ðŸ‡©ðŸ‡®ðŸ‡©zoolztheazðŸ‡®ðŸ‡©ðŸ‡®ðŸ‡©</b>
<code>â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€</code>
...
wget -q https://raw.githubusercontent.com/zoolztheaz1990/Apex/ZX/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
